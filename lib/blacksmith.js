...
smith.loaders = [
  { authors     : require('./loaders/authors')},
  { toc         : require('./loaders/toc')},
  { theme       : require('./loaders/theme')},
  { content     : require('./loaders/content')},
  { rss         : require('./loaders/rss')},
  { errors      : require('./loaders/errors')}
];
