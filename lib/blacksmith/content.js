...
exports.render = function (options, callback) {
  ...
  async.waterfall([
    ...
    function renderMarkdown(source, next) {
      ...
      if (truncate.test(source)) {
        truncated.markdown = source.split(truncate)[0];
...
exports.addSnippets = function (options, callback) {
  ...
  //
  async.forEachLimit(options.files, 10, addSnippet, function (err) {
