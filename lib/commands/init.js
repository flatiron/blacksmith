...
module.exports = function () {
  ...
  // TODO: Add interpretation of arguments passed. An old version of flatiron
  // was not passing argv.
  ...
  smith.sites(function (err, sites) {
    ...
    var getType = function getType (cb) {
      winston.info('init'.yellow + ' can create any of these site types:');
      winston.info('');
      Object.keys(sites).forEach(function (site) {
        winston.info('    * '+site.yellow+ ': '+sites[site].description);
      });
      winston.info('');
