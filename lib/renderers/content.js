  ...
  Object.keys(pages).forEach( function (i) {
    ...
    $('a.snippet', dom).each(function (i, e) {
      var p = path.join(smith.src, e.href),
          ...
          link = $('<a>').attr('href', e.href).attr('class', 'code-link').text(path.basename(e.href)),
    ...
    // This was for a case where the actual "date" class was 3 layers deep.
    // I do not know if this is an issue anymore.
